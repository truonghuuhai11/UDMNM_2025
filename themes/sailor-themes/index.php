...
<main class="main">
    ...
    <div id="hero-carousel" class="carousel slide carousel-fade" data-bs-ride="carousel" data-bs-interval="5000">
      <div class="carousel-item active">
        ...
        <div class="carousel-container">
          <h2><?php _e('Welcome to Sailor', 'sailor-theme'); ?><br></h2>
          <p><?php _e('Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.', 'sailor-theme'); ?></p>
          <a href="<?php echo get_permalink(get_page_by_path('about')); ?>" class="btn-get-started"><?php _e('Get Started', 'sailor-theme'); ?></a>
        </div>
      </div>
      <div class="carousel-item">
        <img src="<?php echo get_template_directory_uri(); ?>/assets/img/hero-carousel/hero-carousel-2.jpg" alt="">
        <div class="carousel-container">
          <h2><?php _e('At vero eos et accusamus', 'sailor-theme'); ?></h2>
          <p><?php _e('Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus id quod maxime placeat facere possimus, omnis voluptas assumenda est, omnis dolor repellendus. Temporibus autem quibusdam et aut officiis debitis aut.', 'sailor-theme'); ?></p>
          <a href="<?php echo get_permalink(get_page_by_path('about')); ?>" class="btn-get-started"><?php _e('Get Started', 'sailor-theme'); ?></a>
        </div>
      </div>
      <div class="carousel-item">
        ...
        <div class="carousel-container">
          <h2><?php _e('Temporibus autem quibusdam', 'sailor-theme'); ?></h2>
          <p><?php _e('Beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt omnis iste natus error sit voluptatem accusantium.', 'sailor-theme'); ?></p>
          <a href="<?php echo get_permalink(get_page_by_path('about')); ?>" class="btn-get-started"><?php _e('Get Started', 'sailor-theme'); ?></a>
        </div>
      </div>
  ...
  <section id="about" class="about section">
    <div class="container section-title" data-aos="fade-up">
      <h2><?php _e('About', 'sailor-theme'); ?></h2>
      <p><?php _e('About Us', 'sailor-theme'); ?><br></p>
    </div>
    <div class="container">
      <div class="row gy-4">
        <div class="col-lg-6 content" data-aos="fade-up" data-aos-delay="100">
          <p>
            <?php _e('Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.', 'sailor-theme'); ?>
          </p>
          <ul>
            <li><i class="bi bi-check2-circle"></i> <span><?php _e('Ullamco laboris nisi ut aliquip ex ea commodo consequat.', 'sailor-theme'); ?></span></li>
            <li><i class="bi bi-check2-circle"></i> <span><?php _e('Duis aute irure dolor in reprehenderit in voluptate velit.', 'sailor-theme'); ?></span></li>
            <li><i class="bi bi-check2-circle"></i> <span><?php _e('Ullamco laboris nisi ut aliquip ex ea commodo', 'sailor-theme'); ?></span></li>
          </ul>
        </div>
        <div class="col-lg-6" data-aos="fade-up" data-aos-delay="200">
          <p><?php _e('Ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.', 'sailor-theme'); ?> </p>
            <a href="<?php echo get_permalink(get_page_by_path('about')); ?>" class="read-more"><span><?php _e('Read More', 'sailor-theme'); ?></span><i class="bi bi-arrow-right"></i></a>
        </div>
      </div>
    </div>
  ...
  <section id="portfolio" class="portfolio section">
    <div class="container section-title" data-aos="fade-up">
      <h2><?php _e('Portfolio', 'sailor-theme'); ?></h2>
      <p><?php _e('Necessitatibus eius consequatur', 'sailor-theme'); ?></p>
    </div>
    <div class="container">
      <div class="isotope-layout" data-default-filter="*" data-layout="masonry" data-sort="original-order">
          ...
          <ul class="portfolio-filters isotope-filters" data-aos="fade-up" data-aos-delay="100">
            <li data-filter="*" class="filter-active"><?php _e('All', 'sailor-theme'); ?></li>
          ...
          <div class="row gy-4 isotope-container" data-aos="fade-up" data-aos-delay="200">
            ...
            ?>
            <p><?php _e('No Portfolio found.', 'sailor-theme'); ?></p>
            <?php endif; ?>
          </div>
      </div>
    </div>
